            ...
            <form onSubmit={handleAddAdmin} className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 bg-gray-50 p-4 rounded-xl border border-gray-100">
              <div className="relative">
                ...
                <input 
                  ...
                  required
                  className="w-full pl-10 pr-4 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-900 placeholder-gray-500 focus:ring-2 focus:ring-purple-500 outline-none shadow-sm font-medium"
                />
              </div>
              <div className="relative">
